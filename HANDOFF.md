...
- **배포**: 프로덕션 `main` = **`8bc6bf2`** (세션13: 회의 DB 뷰 + **AI 리서치 Part 2 = 2a 검색·신뢰도 / 2b 이미지 / 2c 초안·검증**) · https://equria-workflow-sass.vercel.app · **롤백 후보 `a8fb8cb`**(2c 전) / `ac77c71`(2b 전) / `a9f19e6`(AI 리서치 전). 이전 배포분은 git 커밋·아래 로드맵 ✅ 참조.
