...
- **배포**: 프로덕션 `main` = **세션26 브랜드 Complow + 로고·파비콘**(코드 `859cec9`·`c5c33be`) · https://equria-workflow-sass.vercel.app (서울 icn1) · **롤백 후보**: `bdee324`(로고·파비콘 전 = 브랜드만) · `f1199cb`(세션25 엑셀/계산UX) · `c872fb5`(세션24까지).
