...
5. **백로그(대표 연동 필요)** — 회사 카드/금융 실연동(오픈뱅킹, "담당자만"=`064` 위임패턴 재사용) · 카카오(카톡) 연결.
...
- **Supabase**: project `dutovtfdckhayyvhtuxu` (ap-northeast-2 서울) · 마이그 **001~094**.
