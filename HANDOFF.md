...
- **배포**: 프로덕션 `main` = **세션27 Google Drive + Gmail 리치작성/AI 다듬기 + 로딩최적화**(코드 `46cc1de`) · Vercel 프로젝트 `complow-workflow-sass`(서울 icn1) · **롤백 후보**: `676ddcd`(세션26 브랜드/로고 = 드라이브·메일 전) · `bdee324` · `f1199cb`.
