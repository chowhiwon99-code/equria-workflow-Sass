...
const TARGETS = [
  ...
  { icon: Layers, t: "정규직을 더 뽑는 대신 AI로 업무 공백을 메우고 싶은 팀", d: "사람을 더 뽑기 전에 반복 업무부터 맡깁니다. 캘린더·채팅·회의노트·장부·결재를 한곳에서 굴리면서, 손이 가던 일을 에이전트가 대신합니다." },
  { icon: Sparkles, t: "챗지피티는 개인적으로 써봤지만 회사 업무엔 어떻게 붙이는지 모르는 팀", d: "기본 에이전트 3개로 오늘부터 시작하고, 손에 익으면 하나씩 늘려갑니다." },
]
