  ...
  return (
    <footer className="bg-[#111111] text-white">
      <div className="mx-auto max-w-6xl px-6 py-16 sm:py-20">
        ...
        {/* 회사 정보(통신판매업자 표시 — 전자상거래법 §10·PG 심사 요건).
            통신판매업신고번호 = 인천 계양구청 2026-07-31 신고분. 신고증의 생년월일·문서확인번호는 공개 대상이 아니라 넣지 않는다.
            한 줄에 몰면 좁은 화면에서 뭉치므로 상호·번호 / 주소 / 연락처 3줄로 분리. */}
        <div className="mt-16 break-keep text-[13px] leading-relaxed text-white/40">
          <p>컴플로우(Complow) · 대표 조휘원 · 사업자등록번호 592-58-00892 · 통신판매업신고번호 제2026-인천계양-0642호</p>
          <p className="mt-1">주소 인천광역시 계양구 형제봉길 1, 301동 1103호(귤현동, 계양센트레빌3단지)</p>
