...
export default function MailCompose({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-4 right-4 z-50 flex max-h-[calc(100vh-2rem)] w-[460px] max-w-[calc(100vw-2rem)] origin-bottom-right flex-col overflow-hidden rounded-2xl border bg-card shadow-2xl duration-200",
        closing
