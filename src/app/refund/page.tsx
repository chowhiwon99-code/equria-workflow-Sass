...
export default function RefundPage() {
  return (
    <LegalShell title="컴플로우(Complow) 환불정책" effective="2026-07-27">
      ...
      {/* ⚠️ 제6조 1항의 "설정 → 요금제에서 24시간 해지"는 법적 의무다(나이스페이 계약 제22조 ④-2,
          여신전문금융업법 시행령): "정규 영업시간 외에도 철회·취소·해지를 신청할 수 있는 채널을
          운영하여야 한다". 이메일 문의만 적어두면 요건 미달이므로 이 문장을 지우지 말 것.
          구현: src/components/settings/BillingCard.tsx + /api/billing/subscription/cancel */}
      <LegalSection title="제6조 (해지·환불 신청 방법)">
        <p>1. <b>구독 해지</b>는 서비스 내 <b>설정 &gt; 요금제</b> 화면에서 <b>언제든지(영업시간과 무관하게 24시간)</b> 직접 신청할 수 있습니다. 해지 신청 후에도 이미 결제한 이용 기간이 끝나기 전까지는 해지를 취소할 수 있습니다.</p>
        <p>2. <b>환불</b>은 서비스 내 문의 또는 이메일(complow@complow.kr)로 신청할 수 있습니다. 신청 시 결제 정보(결제일·금액·계정 이메일)를 함께 알려주시면 빠르게 처리됩니다.</p>
      </LegalSection>
    </LegalShell>
  )
}
