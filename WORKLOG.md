...
**무엇/왜:** 대표 리포트 — 새 로고(CP 마크)가 탭에서 각진 흰 정사각형으로 보임, "둥근 사각형으로" 요청. 구 아이콘(검정 원+C)의 정체성을 이어 **검정 둥근 사각형(모서리 투명)+흰 CP 마크**로 교체. tsc0·lint29/0(신규0)·build0·main-first. **배포 `94775bf`·롤백 `e4f2a1f`.**
